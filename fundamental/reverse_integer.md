## Problem
Given a signed 32-bit integer, return it with its digits reversed. If reversing causes the value to go outside the signed 32-bit integer range [-2^31, 2^31 - 1], then return 0.
